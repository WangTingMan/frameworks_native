...
namespace android {
namespace os {
class LIBBINDER_EXPORTED BpStatsBootstrapAtomService : public ::android::BpInterface<IStatsBootstrapAtomService> {
public:
  explicit BpStatsBootstrapAtomService(const ::android::sp<::android::IBinder>& _aidl_impl);
  virtual ~BpStatsBootstrapAtomService() = default;
  ::android::binder::Status reportBootstrapAtom(const ::android::os::StatsBootstrapAtom& atom) override;
};  // class BpStatsBootstrapAtomService
}  // namespace os
}  // namespace android
