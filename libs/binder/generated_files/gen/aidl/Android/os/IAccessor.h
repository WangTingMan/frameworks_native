...
class LIBBINDER_EXPORTED LIBBINDER_EXPORT IAccessor : public ::android::IInterface {
public:
...
class LIBBINDER_EXPORTED LIBBINDER_EXPORT IAccessorDefault : public IAccessor {
public:
